...
Page({
  data: {
    ...
    currentimage1:'/pages/images/core/xf/gou.png',
    currentimage2:'/pages/images/core/xf/gou.png',
    color20:'#ffffff',
    color50:'#ffffff',
    color100:'#ffffff',
  },
  ...
  xf_16_16_click(){
    const imageList = ['/pages/images/core/xf/gou.png', '/pages/images/core/xf/gou(1).png'];
